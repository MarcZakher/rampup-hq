      ...
      <div className="max-w-6xl w-full px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 max-w-6xl mx-auto">
          <Button 
            ...
            className="min-h-[180px] w-full py-6 px-4 flex flex-col items-center justify-center gap-4 hover:scale-105 transition-transform bg-white/10 hover:bg-white/20 backdrop-blur-lg border border-white/20"
            variant="ghost"
          >
